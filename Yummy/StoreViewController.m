...
#define phpLink @"http://vps.camilosoler.com/store.php"
...
- (void)viewDidLoad
{
    ...
    NSArray *itemArray = [NSArray arrayWithObjects: @"Todos", @"Nombre", @"Dirección", nil];
    ...
    self.title = [[UILabel alloc] initWithFrame:CGRectMake(200,8,320,30)];
    self.title.text = @"Restaurantes";
